...
document.getElementById('btn_confirm').addEventListener('click', function () {
    ...
    xsend.open("POST", "/Cutting/Payroll_Search/Alert_Update_Status", true);
...
document.getElementById('btn_search').addEventListener('click', function () {
    ...
    var xsend = new XMLHttpRequest();
    xsend.open("POST", "/Cutting/Payroll_Search/Alert", true);
    xsend.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
            console.log(xsend.responseText)
...
function show_image(img_name, img_element) {
    ...
    if (imageExists('../cutting/image/' + image))
        document.getElementById(img_element).src = '../cutting/image/' + image;
    else if (imageExists('../cutting/image2/' + image))
        document.getElementById(img_element).src = '../cutting/image2/' + image;
    else if (imageExists('../cutting/image3/' + image))
        document.getElementById(img_element).src = '../cutting/image3/' + image;
    else if (imageExists('../cutting/image4/' + image))
        document.getElementById(img_element).src = '../cutting/image4/' + image;
}